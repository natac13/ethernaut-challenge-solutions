...
const INSTANCE_ADDRESS = "0xf8d7AfB80A72713060DDEcBC70BBF2Ded45c0488";
...
async function main() {
  ...
  console.log("Is top floor before: ", await contract.top());

  const topFloor = await solution.numOfFloors();
  await solution.useElevator(topFloor);

  console.log("Is top floor after: ", await contract.top());
  /**
