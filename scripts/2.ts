...
const INSTANCE_ADDRESS = "0x97E488375c151b82CeE7DBf689312F636Ec17C5e";
...
async function main() {
  ...
  await contract.Fal1out({ value: ethers.utils.parseUnits("500", "wei") });
  ...
  const tx = await contract.collectAllocations();
  const rc = await tx.wait();
  console.log(JSON.stringify(rc, null, 3));
  console.log(
